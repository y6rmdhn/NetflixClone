...
const OptionLanguage = () => {
  const [language, setLanguage] = useAtom(languageL);
  ...
  return (
    <div className="relative bg-[#1A1510] text-white rounded-full border border-gray-400 w-[200px] pl-8 pr-2">
      <div className="absolute left-2 top-[10px] pl-1">
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
